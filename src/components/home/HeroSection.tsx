...
import { BookOpen, PenTool, Compass, Sparkles } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-3 text-foreground group-hover:text-white">
                ...
                <PenTool className="h-5 w-5 group-hover:rotate-45 transition-transform duration-500" />
              </div>
            </Link>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-1/4 left-1/3 animate-float animation-delay-4000">
            <Sparkles className="h-7 w-7 text-pink-500/40" />
          </div>
        </div>
      </div>
    </div>

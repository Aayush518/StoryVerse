    ...
    <div className="min-h-screen pt-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-gray-800 rounded-lg focus:ring-2 focus:ring-purple-500 w-full sm:w-64"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-4 py-2 bg-gray-800 rounded-lg focus:ring-2 focus:ring-purple-500 appearance-none w-full sm:w-48"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SAMPLE_NFTS.map((nft) => (
            <div key={nft.id} className="bg-gray-800 rounded-xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-bold text-purple-400">{nft.price} ETH</span>
                  </div>
                  <button className="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg transition-colors">
                    Buy Now
                  </button>
                </div>
                <p className="text-sm text-gray-500 mt-4">Created by {nft.creator}</p>
              </div>
            </div>
          ))}
        </div>
